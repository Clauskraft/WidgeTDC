...
export async function ingestionStartHandler(params) {
...
export async function ingestionStatusHandler(params) {
...
export async function ingestionConfigureHandler(params) {
    await initializeAdapters();
