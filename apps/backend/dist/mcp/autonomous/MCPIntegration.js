 ...
 */
export async function registerMCPToolsAsSources() {
 ...
 */
export async function registerDatabaseSource() {
    const sourceRegistry = getSourceRegistry();
    ...
    sourceRegistry.registerSource({
        ...
        estimatedLatency: 50,
        costPerQuery: 0,
        query: async (_operation, _params) => {
 ...
 */
export async function registerOutlookSource() {
    const sourceRegistry = getSourceRegistry();
    // Path to data file
 ...
 */
export async function initializeAutonomousSources() {
