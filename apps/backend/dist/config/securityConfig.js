...
const registrySchema = z.object({
    ...
    streamHeartbeatMs: z.coerce.number().default(10000),
});
let cachedConfig = null;
export function getSecurityIntegrationConfig() {
    if (cachedConfig) {
        return cachedConfig;
    }
    ...
    const registry = registrySchema.parse({
        ...
        streamHeartbeatMs: process.env.SECURITY_ACTIVITY_HEARTBEAT_MS ?? 10000,
    });
