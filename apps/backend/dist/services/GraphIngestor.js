...
export class GraphIngestor {
    ...
    // Node Creation
    // ═══════════════════════════════════════════════════════════════════════
    async createRepositoryNode(repoId) {
    ...
    async createDirectoryNode(dirPath, parentId, depth) {
    ...
    async createFileNode(fileInfo, parentId) {
    ...
    // ═══════════════════════════════════════════════════════════════════════
    async processDirectory(dirPath, parentId, depth) {
