...
import { persistActivityEvent, listActivityEvents, } from './securityRepository.js';
...
export function registerActivityStream(res, options = {}) {
...
export function ingestRegistryEvent(payload) {
    const event = {
