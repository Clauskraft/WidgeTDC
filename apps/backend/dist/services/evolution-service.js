...
export class EvolutionService {
    constructor() {
        // Stier til mapperne
        this.liveDir = path.resolve(__dirname, '../../../../apps/widget-board/src/widgets/generated');
        this.stagingDir = path.resolve(__dirname, '../../../../apps/widget-board/src/widgets/staging');
...
`;
    ...
    async generateWidget(userPrompt) {
        try {
    ...
    async callSmartLLM(userPrompt, componentName) {
