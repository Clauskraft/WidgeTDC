...
export class Neo4jVectorStoreAdapter {
    private graphAdapter = getNeo4jGraphAdapter();
    private embeddings = getEmbeddingService();
    private isInitialized = false;
    private indexName = 'vector_index';
    private dimension = 384; // Default for all-MiniLM-L6-v2
...
// Singleton instance
let neo4jVectorStoreInstance: Neo4jVectorStoreAdapter | null = null;

export function getNeo4jVectorStore(): Neo4jVectorStoreAdapter {
