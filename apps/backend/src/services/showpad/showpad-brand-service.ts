...
import { ShowpadAssetService } from './showpad-asset-service.js';
...
export class ShowpadBrandService {
   ...
   */
  private async extractColorsFromPPT(_pptPath: string): Promise<BrandColors> {
   ...
   */
  private async extractTypographyFromPPT(_pptPath: string): Promise<Typography> {
...
export type { BrandColors, Typography, LogoSpecs, BrandContext };
