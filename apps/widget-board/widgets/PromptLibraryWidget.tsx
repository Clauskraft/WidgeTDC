...
const MOCK_PROMPTS: Prompt[] = [
  {
    id: '1',
    title: 'Opsummer GDPR Artikel 5',
    text: 'Giv en koncis opsummering af hovedpunkterne i GDPR Artikel 5.',
    category: 'GDPR',
    tags: ['opsummering', 'artikel-5'],
  },
  {
    id: '2',
    title: 'Analyser Schrems II',
    text: 'Giv en statusoversigt over Schrems II-dommen og dens konsekvenser.',
    category: 'Compliance',
    tags: ['schrems-ii', 'dataoverførsel'],
  },
  {
    id: '3',
    title: 'Databehandleraftale Check',
    text: 'Oplist de nødvendige punkter for en GDPR-kompatibel databehandleraftale.',
    category: 'Kontrakt',
    tags: ['dpa', 'compliance'],
  },
];
