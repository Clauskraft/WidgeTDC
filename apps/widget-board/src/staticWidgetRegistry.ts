...
export const widgetMetadata: Record<string, { name: string; description: string; category: string; defaultLayout: { w: number; h: number } }> = {
  ...
  'PlatformModelGovernanceWidget': { name: 'AI Model Governance', description: 'Central styring af AI modeller, budgetter og policies', category: 'settings', defaultLayout: { w: 12, h: 4 } },
