...
const HelpModal: React.FC<HelpModalProps> = ({ isOpen, onClose }) => {
  ...
  const codeClasses =
    'px-2 py-1 text-sm bg-gray-200 dark:bg-gray-700 rounded font-mono text-blue-600 dark:text-blue-300';
    ...
    >
      ...
      >
        <header className="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700">
          ...
          <button onClick={onClose} className="ms-icon-button ms-focusable" title="Luk">
        ...
        <main className="overflow-y-auto p-6 space-y-6">
          ...
          <section>
            ...
            <p className={paragraphClasses}>
              ...
              React Functional Component og modtage{' '}
              <code className={codeClasses}>widgetId: string</code> som prop.
            </p>
...
export default MyAwesomeWidget;`}
            ...
            <p className={paragraphClasses}>
              Åbn <code className={codeClasses}>src/constants.ts</code> og tilføj din nye widget til{' '}
              <code className={codeClasses}>WIDGET_DEFINITIONS</code> array'et.
            </p>
            <pre className="bg-gray-100 dark:bg-gray-900 p-3 rounded-md text-sm overflow-x-auto">
...
export const WIDGET_DEFINITIONS: WidgetDefinition[] = [
  // ... eksisterende widgets
  {
    ...
    defaultLayout: { w: 4, h: 5 } // Standard bredde og højde i grid-enheder
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300">
              <li>
                <b>Styling:</b> Brug Tailwind CSS for at sikre et konsistent design. Dit widget skal
                være responsivt inden for sin container.
              </li>
              <li>
                <b>Global State:</b> Importer <code className={codeClasses}>useGlobalState</code>{' '}
                fra <code className={codeClasses}>'./contexts/GlobalStateContext'</code> for at gøre
                dit widget opmærksom på temaet (dark/light) og andre globale indstillinger.
              </li>
              <li>
                <b>Selvstændighed:</b> Widgets bør være så selvstændige som muligt og håndtere deres
                egen state, datahentning, loading og fejlstatus.
              </li>
            </ul>
          </section>
        </main>
