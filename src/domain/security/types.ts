...
export interface SecurityOverwatchService {
   ...
   */
  updateAlert(id: AlertId, updates: Partial<Omit<SecurityAlert, 'id' | 'detectedAt'>>): Promise<SecurityAlert>;
   ...
   * @returns Updated alert
   */
  resolveAlert(id: AlertId, resolution: { status: AlertStatus; notes?: string }): Promise<SecurityAlert>;
   ...
   */
  getVulnerabilities(filters?: { severity?: AlertSeverity; patchAvailable?: boolean }): Promise<Vulnerability[]>;
   ...
   */
  getThreatIntelligence(filters?: { type?: ThreatIntelligence['type']; minConfidence?: number }): Promise<ThreatIntelligence[]>;
